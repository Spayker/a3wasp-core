...
while {!isnull player} do 
{
	if ((alive player)&&(eyePos player select 2 > 0)) then 
	{
		...
		drop [["\A3\data_f\ParticleEffects\Universal\Universal",16,12,8,1],"","Billboard",0.15,0.3,[0,0,0],[_flow#0,_flow#1,-0.2],3,1.2,1,0,[0.1,.2,.3],[[1,1,1,0.05],[1,1,1,0.2],[1,1,1,0.05]],[0.1],0,0.04,"","Common\Module\Weather\SnowStorm\al_breath.sqf",_alias_breath,90];
