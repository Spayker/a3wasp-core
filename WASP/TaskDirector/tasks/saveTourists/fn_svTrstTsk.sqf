...
switch (_stage) do {
    ...
    case 15: {
        [player, format ["DlrScudTwn%1", getPlayerUID player], [format [localize "STR_WF_M_InterceptScudDesc", _twn],
                    localize "STR_WF_M_DeliverScudTownTitle", "Attack"], _twnPos,
                    "CREATED", 0, true, "Attack", true] call BIS_fnc_taskCreate;
    };
    case 16: {
        [format ["DlrScudTwn%1", getPlayerUID player], "SUCCEEDED"] call BIS_fnc_taskSetState;
    };
    case 17: {
        [format ["DlrScudTwn%1", getPlayerUID player], "FAILED"] call BIS_fnc_taskSetState;
    };
